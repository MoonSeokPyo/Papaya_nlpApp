...
public interface RestaurantRepository extends JpaRepository<Restaurant, Long> {
	...
	List<RestaurantDTO> findRestaurantsByLocation(@Param("address") String address,@Param("latitude") double latitude,@Param("longitude") double longitude);
	...
	List<RestaurantDTO> searchRestaurantsByName(@Param("name") String name,@Param("latitude") double latitude,@Param("longitude") double longitude);
